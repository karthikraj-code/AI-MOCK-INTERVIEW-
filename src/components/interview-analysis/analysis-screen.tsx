      ...
      <div className="relative flex items-center justify-center">
        <div className="relative">
          ...
          <div className="relative z-10">
            <BrainCircuit className="h-20 w-20 text-blue-600 animate-pulse" />
          </div>
          

          
          {/* Decorative ring animation */}
          <div className="absolute inset-0 rounded-full border-2 border-blue-400/30 animate-ping scale-125"></div>
        </div>
      </div>
